...
const cacheName = 'LAWk5AbrahamJoseph-2021-03-05 17:51:02.015073'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWk5AbrahamJoseph'.length) === 'LAWk5AbrahamJoseph') {
